...
import com.vladus177.common_feature.Feature
import com.vladus177.common_presentation.AppUiContainer
import com.vladus177.common_presentation.extensions.observe
import com.vladus177.dynamicfeatures.installdialog.createInstallDialogFragment
...
class MainActivity : AppCompatActivity(), HasAndroidInjector, AppUiContainer,
    ...
    private fun goToFeatureEntryPoint(@IdRes actionId: Int) {
        ...
        when (actionId) {
            R.id.actionHome -> transaction.setCustomAnimations(
                R.anim.slide_out_right,
                R.anim.slide_in_right
            )
            R.id.actionDogs -> transaction.setCustomAnimations(
